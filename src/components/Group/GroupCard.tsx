...
import { GroupCardData } from '../../business/GroupBusiness'
...
const GroupCard = ({ card, onVerDetalle }: GroupCardProps) => {
  return (
    <div className="flex flex-col justify-between rounded-xl border border-stroke bg-white p-6 shadow-md dark:border-strokedark dark:bg-boxdark">
      ...
      <ul className="mb-5 flex flex-col gap-2.5">
        ...
        <li className="flex items-center gap-2 text-sm text-bodydark1 dark:text-bodydark2">
          ...
          <span>{card.studentCount} estudiante{card.studentCount !== 1 ? 's' : ''}</span>
        </li>
      </ul>
